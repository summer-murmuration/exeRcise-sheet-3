...
```markdown
In Figure \@ref(fig:createplot), the average age at marriage is displayed in two lines, seperated by gender. It shows how this trend has developed over time.
